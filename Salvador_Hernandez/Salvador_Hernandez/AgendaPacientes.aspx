<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgendaPacientes.aspx.cs" Inherits="Salvador_Hernandez.AgendaPacientes" %>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="auto-style12" colspan="2">
                        <asp:Button ID="ButtonPaciente" runat="server" Height="34px" Text="Pacientes" Width="100px" OnClick="ButtonPaciente_Click" />
                    </td>
