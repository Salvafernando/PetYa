<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CRUDFarmaco.aspx.cs" Inherits="Salvador_Hernandez.Presentacion.CRUDFarmaco" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width:100%;">
                <tr>
                    <td class="auto-style4" colspan="3">FICHA FARMACO</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBoxCantidad" EnableClientScript="False" ErrorMessage="RequiredFieldValidator" ForeColor="Red">Debe ingresar una cantidad</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style8">&nbsp;</td>
