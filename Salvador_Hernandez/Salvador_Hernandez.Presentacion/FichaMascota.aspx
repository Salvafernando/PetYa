<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FichaMascota.aspx.cs" Inherits="Salvador_Hernandez.Presentacion.FichaMascota" %>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        ...
                        <textarea id="txtAnamnesis" name="S1" runat="server" class="auto-style4"></textarea></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:TextBox ID="txtSVitales" runat="server" OnTextChanged="txtSVitales_TextChanged"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">
                        <asp:TextBox ID="txtPDiagnostico" runat="server"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style2">
                        <textarea id="txtPronostico" name="S2" class="auto-style5" runat="server"></textarea></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">
                        <textarea id="txtTratamiento" name="S3" class="auto-style6" runat="server"></textarea></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style2">
                        <textarea id="txtObservaciones" name="S4" class="auto-style7" runat="server"></textarea></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
