<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VistaCliente.aspx.cs" Inherits="Salvador_Hernandez.VistaCliente" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table style="width:100%;">
                <tr>
                    <td class="auto-style3" colspan="3">PetYa</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style12" colspan="2">
                        <asp:Button ID="ButtonMiMascota" runat="server" Height="34px" Text="Mi Mascota" Width="150px" OnClick="ButtonMiMascota_Click" />
                    </td>
