...
{
    public partial class AuditoriaFarmaco : System.Web.UI.Page
    {
        ...
        public void listar()
        {
            DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.ObtenerDatosFarmaco();
...

        {
...

            {
...

                {
                    ...
                    DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.BuscarFarmaco(accion);
