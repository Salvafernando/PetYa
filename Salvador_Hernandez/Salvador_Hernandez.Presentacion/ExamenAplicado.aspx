<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamenAplicado.aspx.cs" Inherits="Salvador_Hernandez.Presentacion.ExamenAplicado" %>
...
<body>
    ...
    <form id="form1" runat="server">
                ...
                <table style="width:100%;">
                    <tr>
                        <td>Buscar por Rut Dueño:</td>
                        <td>
                             <asp:TextBox ID="txtId" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Button ID="btnBuscar" runat="server" Text="Buscar Examenes" OnClick="BtnBuscar_Click" />
                        </td>
                </tr>
                <tr>
