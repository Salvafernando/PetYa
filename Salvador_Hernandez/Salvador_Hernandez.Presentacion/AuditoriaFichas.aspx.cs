...
{
    public partial class AuditoriaFichas : System.Web.UI.Page

    {
...

        {
            ...
            DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.ObtenerDatosFichas();
...

        {
...

            {
...

                {
                    ...
                    DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.BuscarAFicha(accion);
