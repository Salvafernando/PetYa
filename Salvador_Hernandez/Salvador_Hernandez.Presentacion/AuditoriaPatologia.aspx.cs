...
{
    public partial class AuditoriaPatologia : System.Web.UI.Page
    {
        ...
        public void listar()
        {
            DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.ObtenerDatosPatologia();
...

        {
...

            {
...

                {
                    ...
                    DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.BuscarPatologia(accion);
