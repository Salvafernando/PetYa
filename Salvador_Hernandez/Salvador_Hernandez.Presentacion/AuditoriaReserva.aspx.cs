...
{
    public partial class AuditoriaReserva : System.Web.UI.Page
    {
        ...
        public void listar()
        {
            DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.ObtenerDatosReserva();
...

        {
...

            {
...

                {
                    ...
                    DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.BuscarReserva(accion);
