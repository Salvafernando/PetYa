...
{
    public partial class AuditoriaGps : System.Web.UI.Page
    {
        ...
        public void listar()
        {
            DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.ObtenerDatosGps();
...

        {
...

            {
...

                {
                    ...
                    DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.BuscarGps(accion);
