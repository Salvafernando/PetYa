...
{
    public partial class AuditoriaExamen : System.Web.UI.Page
    {
        ...
        public void listar()
        {
            DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.ObtenerDatosExamen();
...

        {
...

            {
...

                {
                    ...
                    DataTable dt = Salvador_Hernandez.AccesoDatos.Auditoria.BuscarExamen(accion);
