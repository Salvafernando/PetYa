<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FarmacoAplicado.aspx.cs" Inherits="Salvador_Hernandez.Presentacion.FarmacoAplicado" %>
...
<body>
    ...
    <form id="form1" runat="server">
                ...
                <table style="width:100%;">
                    <tr>
                        <td>Buscar por Rut Dueño de mascota:</td>
                        <td>
                             <asp:TextBox ID="txtId" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Button ID="btnBuscar" runat="server" Text="Buscar Farmacos" OnClick="BtnBuscar_Click" />
                        </td>
                </tr>
                <tr>
                    <td class="auto-style1">&nbsp;</td>
                    <td class="auto-style2">Reporteria</td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style1">&nbsp;</td>
